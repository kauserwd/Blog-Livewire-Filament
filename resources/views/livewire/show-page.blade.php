            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; {{ $pages->title}}
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7">
                        <div class="section-title">
                            <p class="text-primary text-uppercase fw-bold mb-3">{{ $pages->title}}</p>
                            {!! $pages->content !!}
                            {{-- <p class="text-primary text-uppercase fw-bold mb-3">{{ $pages->title}}</p>
                    ...
                    <div class="col-lg-4 mt-5 mt-lg-0">
                        <img loading="lazy" decoding="async" src="{{ asset('storage/'.$pages->image)}}" alt="Business Loans &lt;br&gt; For Daily Expenses" class="rounded w-100">
                    </div>
                </div>
                @else
                <div class="row justify-content-center align-items-center">
