                                    ...
                                    <div class="col-md-6" data-aos="fade">
                                        <article class="blog-post">
                                            ...
                                            <div class="pt-4">
                                                ...
                                                <h2 class="h4"><a wire:navigate class="text-black" href="{{ route('blogDetails',$article->id)}}">{{ $article->title }}</a></h2>
                                                <p>Heading example Here is example of hedings. You can use this heading by following …</p> <a wire:navigate href="{{ route('blogDetails',$article->id)}}" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Read More</a>
                                            </div>
                                        </article>
                                    </div>
                                @endforeach
                                ...
                                <ul class="list-unstyled widget-list">
                                    <li class="d-flex widget-post align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="h6 mb-0"><a wire:navigate class="text-black" href="{{ route('blogDetails',$latestArticle->id)}}">{{ $latestArticle->title }}</a></h5>
