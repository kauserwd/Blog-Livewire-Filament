		...
		<div class="row justify-content-between">
				...
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						@foreach (getServices() as $service)
							<li class="mb-2"><a wire:navigate href="{{ route('ServiceDetails',$service->id )}}">{{ $service->title }}</a></li>
						@endforeach
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="list-inline-item me-4"><a class="text-black" wire:navigate href="{{ route('page',4) }}">Privacy Policy</a>
                        </li>
